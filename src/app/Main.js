...
class Main extends Component {
  ...
  checkJobStatus = (job) => {
    ...
    function updateJobState (data) {
      let updated = component.state.jobIDs.map(function(jobToUpdate) {
          ...
          >
            ...
            >
              <Paper style={paperStyle} zDepth={1}>
                ...
                /><br />
                <RaisedButton label="Submit" primary={true} onClick={this.submitUrl} />
                </div>
              ...
              <Card key={job.job_id} style={{ marginTop: "12px" }} initiallyExpanded={false}>
                ...
                <CardActions expandable={true}>
                  <RaisedButton
                    ...
                    primary={true}
                    onTouchTap={() => { this.checkJobStatus(job)}}
              ...
              >
              {this.state.htmlContent !== null  ? <HtmlIframe content={this.state.htmlContent}/> : null}
              </Dialog>
